...
def data_from_name(proj_dir,name, noise = 0.0, theta=2.4):
    ...
    if name =='PM2.5':
        train_file = os.path.join(proj_dir, 'data/2019_2021_hourly.csv')
        test_file = os.path.join(proj_dir, 'data/2019_2021_hourly_test_x.csv')
        val_file = os.path.join(proj_dir, 'data/2019_2021_hourly_val_x.csv')
